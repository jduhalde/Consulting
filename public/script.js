...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.addEventListener('click', (e) => {
        ...
        // Previene el salto en el link del botón "Volver Arriba"
        if (href === '#') {
            e.preventDefault();
    ...
    const mainNav = qs('#mainNav > ul'); // Apuntar a la lista UL
    ...
    // --- Validación Formulario de Contacto (Simulado) ---
        ...
        contactForm.addEventListener('submit', (e) => {
            ...
            const msgs = {
                es: {
                    ...
                    success: 'Mensaje enviado (simulado). Gracias.'
                },
                en: {
                    fill: 'Please fill in all fields.',
                    email: 'Please enter a valid email.',
                    success: 'Message sent (simulated). Thank you.'
                }
            };
    ...
    // --- Resaltado de Navegación al hacer Scroll (ACTUALIZADO) ---
        ...
        const observer = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    // Lógica para agrupar el dropdown "Soluciones"
                    ...
                    navLinks.forEach(link => {
                        ...
                        // Solo aplicamos 'active' a los links que están en la página (hash links)
...
if (loginForm) {
    ...
    // Configuración Firebase (la variable firebaseConfig es cargada desde firebase-config.js)

    const checkFirebase = () => {
        if (typeof firebase !== 'undefined' && firebase.app && firebase.auth && firebase.storage && typeof firebaseConfig !== 'undefined') {
            initializeFirebase();
        } else {
    ...
    function initializeFirebase() {
        ...
        if (loginBtn) {
            loginBtn.addEventListener('click', () => {
                ...
                loginError.style.color = 'var(--color-error)'; // Reset color on action
